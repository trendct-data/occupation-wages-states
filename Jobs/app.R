...
ui <- shinyUI(fluidPage(
   ...
   sidebarLayout(
      ...
      mainPanel(
        ...
        p("In `r state_name`, there are about `r total_emp` million full-time workers."),
        
        p("Most workers in the state are in major job category of `r most_workers_state$major_title` (about `r most_workers_state$major_percent` percent). More specifically, the most employed people in the state work as `r most_workers_state$detailed_title` (`r most_workers_state$detailed_percent` percent).")
